 ...
 * @subpackage	Views
 */
class PizzzaViewCategory extends JView
{
    /**
    ...
    public function display($tpl = null)
    {
        ...
        $model = JModel::getInstance('categories', 'Pizzzamodel');
        ...
        for($i = 0; $i < $count; $i ++)
        {
            ...
            $link = JRoute::_('index.php?view=Pizzza&catid='.$category->slug.'&id='.$item->slug);
        ...
        {
            $cat =& $categories[$i];
            $cat->link = JRoute::_('index.php?option=com_pizzza&view=category&id='.$cat->slug);
        }//for
