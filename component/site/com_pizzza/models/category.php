 ...
 * @subpackage Models
 */
class PizzzaModelCategory extends JModel
{
    /**
     * Category id
     *
    ...
    public function __construct()
    {
        ...
        $this->setState('limit', $app->getUserStateFromRequest('com_pizzza.limit'
    ...
    /**
     * Method to get a pagination object of the Pizzza items for the category.
     *
     * @access public
...
//                return false;
    ...
    private function loadCategory()
    {
        if(empty($this->_category))
        {
            ...
            $query = $this->_db->getQuery(true)
                ...
                ->where('c.extension = '.$this->_db->quote('com_pizzza'));
    ...
    private function buildQuery()
    {
        ...
        $query = $this->_db->getQuery(true)
            ->from($this->_db->quoteName('#__pizzza'))
            ->select('*')
